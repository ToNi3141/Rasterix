...
set_property -dict { PACKAGE_PIN M3    IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { serCts }]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
# set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { dispData[5] }]; #IO_L12P_T1_MRCC_16 Sch=pio[03]
# set_property -dict { PACKAGE_PIN K3    IOSTANDARD LVCMOS33 } [get_ports { dispData[4] }]; #IO_L7N_T1_AD6N_35 Sch=pio[04]
# set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { dispData[3] }]; #IO_L11P_T1_SRCC_16 Sch=pio[05]
# set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { dispData[2] }]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
# set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports { dispData[1] }]; #IO_L6N_T0_VREF_16 Sch=pio[07]
# set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports { dispData[0] }]; #IO_L11N_T1_SRCC_16 Sch=pio[08]
# set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { dispRd }]; #IO_L6P_T0_16 Sch=pio[09]
# set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { dispWr }]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
# set_property -dict { PACKAGE_PIN J1    IOSTANDARD LVCMOS33 } [get_ports { dispDc }]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]
# set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { dispCs }]; #IO_L5P_T0_AD13P_35 Sch=pio[12]
# set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports { dispRst }]; #IO_L6N_T0_VREF_35 Sch=pio[13]
...
set_property -dict { PACKAGE_PIN T3    IOSTANDARD LVCMOS33 } [get_ports { dispCs }]; #IO_L2N_T0_34 Sch=pio[27]
set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports { dispDc }]; #IO_L1P_T0_34 Sch=pio[28]
set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports { dispWr }]; #IO_L3P_T0_DQS_34 Sch=pio[29]
set_property -dict { PACKAGE_PIN T2    IOSTANDARD LVCMOS33 } [get_ports { dispRd }]; #IO_L1N_T0_34 Sch=pio[30]
set_property -dict { PACKAGE_PIN U1    IOSTANDARD LVCMOS33 } [get_ports { dispRst }]; #IO_L3N_T0_DQS_34 Sch=pio[31]
...
set_property -dict { PACKAGE_PIN V4    IOSTANDARD LVCMOS33 } [get_ports { dispData[0] }]; #IO_L11N_T1_SRCC_34 Sch=pio[37]
set_property -dict { PACKAGE_PIN U4    IOSTANDARD LVCMOS33 } [get_ports { dispData[1] }]; #IO_L11P_T1_SRCC_34 Sch=pio[38]
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { dispData[2] }]; #IO_L16N_T2_34 Sch=pio[39]
set_property -dict { PACKAGE_PIN W4    IOSTANDARD LVCMOS33 } [get_ports { dispData[3] }]; #IO_L12N_T1_MRCC_34 Sch=pio[40]
set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { dispData[4] }]; #IO_L16P_T2_34 Sch=pio[41]
set_property -dict { PACKAGE_PIN U2    IOSTANDARD LVCMOS33 } [get_ports { dispData[5] }]; #IO_L9N_T1_DQS_34 Sch=pio[42]
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { dispData[6] }]; #IO_L13N_T2_MRCC_34 Sch=pio[43]
set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports { dispData[7] }]; #IO_L9P_T1_DQS_34 Sch=pio[44]
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { serMosi }]; #IO_L19P_T3_34 Sch=pio[45]
set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { serCs }]; #IO_L13P_T2_MRCC_34 Sch=pio[46]
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { serSck }]; #IO_L14P_T2_SRCC_34 Sch=pio[47]
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { serMiso }]; #IO_L14N_T2_SRCC_34 Sch=pio[48]
...
# SPI clock
create_clock -add -name clk_port_spi -period 20 -waveform {0 10} [get_ports { serSck }];
# SPI
set_input_delay -max -clock clk_port_spi 3.5 [get_ports reset]
set_input_delay -max -clock clk_port_spi 3.5 [get_ports serMosi]
set_input_delay -max -clock clk_port_spi 3.5 [get_ports serCs]
set_output_delay -max -clock clk_port_spi 3.5 [get_ports serMiso]
set_input_delay -min -clock clk_port_spi 3.0 [get_ports reset]
set_input_delay -min -clock clk_port_spi 3.0 [get_ports serMosi]
set_input_delay -min -clock clk_port_spi 3.0 [get_ports serCs]
set_output_delay -min -clock clk_port_spi 3.0 [get_ports serMiso]

# Virtual 100MHz clock
create_clock -name clk_port_virt -period 10
set_input_delay -max -clock clk_port_virt 3.5 [get_ports reset]
set_output_delay -max -clock clk_port_virt 3.5 [get_ports serCts]
set_input_delay -min -clock clk_port_virt 3.0 [get_ports reset]
set_output_delay -min -clock clk_port_virt 3.0 [get_ports serCts]
# Display
set_output_delay -max -clock clk_port_virt 3.5 [get_ports dispData[*]]
set_output_delay -max -clock clk_port_virt 3.5 [get_ports dispRd]
set_output_delay -max -clock clk_port_virt 3.5 [get_ports dispWr]
set_output_delay -max -clock clk_port_virt 3.5 [get_ports dispDc]
set_output_delay -max -clock clk_port_virt 3.5 [get_ports dispCs]
set_output_delay -max -clock clk_port_virt 3.5 [get_ports dispRst]
set_output_delay -min -clock clk_port_virt 3.0 [get_ports dispData[*]]
set_output_delay -min -clock clk_port_virt 3.0 [get_ports dispRd]
set_output_delay -min -clock clk_port_virt 3.0 [get_ports dispWr]
set_output_delay -min -clock clk_port_virt 3.0 [get_ports dispDc]
set_output_delay -min -clock clk_port_virt 3.0 [get_ports dispCs]
set_output_delay -min -clock clk_port_virt 3.0 [get_ports dispRst]
# SRAM
set_output_delay -max -clock clk_port_virt 3.5 [get_ports MemAdr[*]]
set_input_delay -max -clock clk_port_virt 3.5 [get_ports MemDB[*]]
set_output_delay -max -clock clk_port_virt 3.5 [get_ports MemDB[*]]
set_output_delay -max -clock clk_port_virt 3.5 [get_ports RamOEn]
set_output_delay -max -clock clk_port_virt 3.5 [get_ports RamWEn]
set_output_delay -max -clock clk_port_virt 3.5 [get_ports RamCEn]
set_output_delay -min -clock clk_port_virt 3.0 [get_ports MemAdr[*]]
set_input_delay -min -clock clk_port_virt 3.0 [get_ports MemDB[*]]
set_output_delay -min -clock clk_port_virt 3.0 [get_ports MemDB[*]]
set_output_delay -min -clock clk_port_virt 3.0 [get_ports RamOEn]
set_output_delay -min -clock clk_port_virt 3.0 [get_ports RamWEn]
set_output_delay -min -clock clk_port_virt 3.0 [get_ports RamCEn]
set_property IOB TRUE [get_ports MemAdr[*]]
set_property IOB TRUE [get_ports RamOEn]
set_property IOB TRUE [get_ports RamWEn]
set_property IOB TRUE [get_ports RamCEn]
