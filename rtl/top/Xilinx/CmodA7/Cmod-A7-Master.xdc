...
set_property -dict { PACKAGE_PIN M3    IOSTANDARD LVCMOS33 } [get_ports { dispData[7] }]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { dispData[6] }]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
...
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_L13N_T2_MRCC_34 Sch=pio[43]
set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports { serCts }]; #IO_L9P_T1_DQS_34 Sch=pio[44]
