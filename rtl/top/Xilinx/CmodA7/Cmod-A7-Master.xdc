...
set_property -dict { PACKAGE_PIN J1    IOSTANDARD LVCMOS33 } [get_ports { dispCs }]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]
set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { dispDc }]; #IO_L5P_T0_AD13P_35 Sch=pio[12]
