...
set_property -dict { PACKAGE_PIN Y1    IOSTANDARD TMDS_33  } [get_ports { hdmi_tx_b_n }]; #IO_L5N_T0_34 Sch=hdmi_tx_n[0]
set_property -dict { PACKAGE_PIN W1    IOSTANDARD TMDS_33  } [get_ports { hdmi_tx_b_p }]; #IO_L5P_T0_34 Sch=hdmi_tx_p[0]
set_property -dict { PACKAGE_PIN AB1   IOSTANDARD TMDS_33  } [get_ports { hdmi_tx_g_n }]; #IO_L7N_T1_34 Sch=hdmi_tx_n[1]
set_property -dict { PACKAGE_PIN AA1   IOSTANDARD TMDS_33  } [get_ports { hdmi_tx_g_p }]; #IO_L7P_T1_34 Sch=hdmi_tx_p[1]
set_property -dict { PACKAGE_PIN AB2   IOSTANDARD TMDS_33  } [get_ports { hdmi_tx_r_n }]; #IO_L8N_T1_34 Sch=hdmi_tx_n[2]
set_property -dict { PACKAGE_PIN AB3   IOSTANDARD TMDS_33  } [get_ports { hdmi_tx_r_p }]; #IO_L8P_T1_34 Sch=hdmi_tx_p[2]
...
set_property -dict { PACKAGE_PIN AB22  IOSTANDARD LVCMOS33 } [get_ports { ftRxf }]; #IO_L10N_T1_D15_14 Sch=ja[1]
set_property -dict { PACKAGE_PIN AB21  IOSTANDARD LVCMOS33 } [get_ports { ftRd }]; #IO_L10P_T1_D14_14 Sch=ja[2]
set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { ftClk }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ja[3]
set_property -dict { PACKAGE_PIN AB18  IOSTANDARD LVCMOS33 } [get_ports { resetn_in }]; #IO_L17N_T2_A13_D29_14 Sch=ja[4]
# set_property -dict { PACKAGE_PIN Y21   IOSTANDARD LVCMOS33 } [get_ports { ftData[4] }]; #IO_L9P_T1_DQS_14 Sch=ja[7]
# set_property -dict { PACKAGE_PIN AA21  IOSTANDARD LVCMOS33 } [get_ports { ftData[5] }]; #IO_L8N_T1_D12_14 Sch=ja[8]
# set_property -dict { PACKAGE_PIN AA20  IOSTANDARD LVCMOS33 } [get_ports { ftData[6] }]; #IO_L8P_T1_D11_14 Sch=ja[9]
# set_property -dict { PACKAGE_PIN AA18  IOSTANDARD LVCMOS33 } [get_ports { ftData[7] }]; #IO_L17P_T2_A14_D30_14 Sch=ja[10]
...
## Pmod header JB
set_property -dict { PACKAGE_PIN V9    IOSTANDARD LVCMOS33 } [get_ports { ck_a0 }]; #IO_L21P_T3_DQS_34 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { ck_a1 }]; #IO_L21N_T3_DQS_34 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 } [get_ports { ck_a2 }]; #IO_L19P_T3_34 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { ck_a3 }]; #IO_L19N_T3_VREF_34 Sch=jb_n[2]
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { ck_a4 }]; #IO_L24P_T3_34 Sch=jb_p[3]
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { ck_a5 }]; #IO_L24N_T3_34 Sch=jb_n[3]
...
## Pmod header JC
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports { ck_io[0] }]; #IO_L18P_T2_34 Sch=jc_p[1]
set_property -dict { PACKAGE_PIN AA6   IOSTANDARD LVCMOS33 } [get_ports { ck_io[1] }]; #IO_L18N_T2_34 Sch=jc_n[1]
set_property -dict { PACKAGE_PIN AA8   IOSTANDARD LVCMOS33 } [get_ports { ck_io[2] }]; #IO_L22P_T3_34 Sch=jc_p[2]
set_property -dict { PACKAGE_PIN AB8   IOSTANDARD LVCMOS33 } [get_ports { ck_io[3] }]; #IO_L22N_T3_34 Sch=jc_n[2]
set_property -dict { PACKAGE_PIN R6    IOSTANDARD LVCMOS33 } [get_ports { ck_io[4] }]; #IO_L17P_T2_34 Sch=jc_p[3]
set_property -dict { PACKAGE_PIN T6    IOSTANDARD LVCMOS33 } [get_ports { ck_io[5] }]; #IO_L17N_T2_34 Sch=jc_n[3]
set_property -dict { PACKAGE_PIN AB7   IOSTANDARD LVCMOS33 } [get_ports { ck_io[6] }]; #IO_L20P_T3_34 Sch=jc_p[4]
set_property -dict { PACKAGE_PIN AB6   IOSTANDARD LVCMOS33 } [get_ports { ck_io[7] }]; #IO_L20N_T3_34 Sch=jc_n[4]

## XADC Header
# set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { ftRxf }]; #IO_L3P_T0_DQS_AD1P_15 Sch=xa_p[1]
# #set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { xa_n[0] }]; #IO_L3N_T0_DQS_AD1N_15 Sch=xa_n[1]
# set_property -dict { PACKAGE_PIN H13   IOSTANDARD LVCMOS33 } [get_ports { ftRd }]; #IO_L1P_T0_AD0P_15 Sch=xa_p[2]
# #set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { xa_n[1] }]; #IO_L1N_T0_AD0N_15 Sch=xa_n[2]
# set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { ftClk }]; #IO_L2P_T0_AD8P_15 Sch=xa_p[3]
# #set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { xa_n[2] }]; #IO_L2N_T0_AD8N_15 Sch=xa_n[3]
# set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { resetn_in }]; #IO_L5P_T0_AD9P_15 Sch=xa_p[4]
# #set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { xa_n[3] }]; #IO_L5N_T0_AD9N_15 Sch=xa_n[4]

set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { ftData[0] }]; #IO_L3P_T0_DQS_AD1P_15 Sch=xa_p[1]
set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { ftData[4] }]; #IO_L3N_T0_DQS_AD1N_15 Sch=xa_n[1]
set_property -dict { PACKAGE_PIN H13   IOSTANDARD LVCMOS33 } [get_ports { ftData[1] }]; #IO_L1P_T0_AD0P_15 Sch=xa_p[2]
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { ftData[5] }]; #IO_L1N_T0_AD0N_15 Sch=xa_n[2]
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { ftData[2] }]; #IO_L2P_T0_AD8P_15 Sch=xa_p[3]
set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { ftData[6] }]; #IO_L2N_T0_AD8N_15 Sch=xa_n[3]
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { ftData[3] }]; #IO_L5P_T0_AD9P_15 Sch=xa_p[4]
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { ftData[7] }]; #IO_L5N_T0_AD9N_15 Sch=xa_n[4]
...
set_property -dict { PACKAGE_PIN K22   IOSTANDARD LVCMOS25 } [get_ports { fmc_resetn }]; #IO_L9N_T1_DQS_AD3N_15 Sch=fmc_la_n[10]
set_property -dict { PACKAGE_PIN K21   IOSTANDARD LVCMOS25 } [get_ports { fmc_wkup }]; #IO_L9P_T1_DQS_AD3P_15 Sch=fmc_la_p[10]
...
set_property -dict { PACKAGE_PIN H22   IOSTANDARD LVCMOS25 } [get_ports { fmc_gpio1 }]; #IO_L7N_T1_AD2N_15 Sch=fmc_la_n[14]
set_property -dict { PACKAGE_PIN J22   IOSTANDARD LVCMOS25 } [get_ports { fmc_gpio0 }]; #IO_L7P_T1_AD2P_15 Sch=fmc_la_p[14]
...
set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS25 } [get_ports { fmc_clk }]; #IO_L12P_T1_MRCC_16 Sch=fmc_la18_cc_p
set_property -dict { PACKAGE_PIN A19   IOSTANDARD LVCMOS25 } [get_ports { fmc_txen }]; #IO_L17N_T2_16 Sch=fmc_la_n[19]
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS25 } [get_ports { fmc_rxfn }]; #IO_L17P_T2_16 Sch=fmc_la_p[19]
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS25 } [get_ports { fmc_rdn }]; #IO_L18N_T2_16 Sch=fmc_la_n[20]
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS25 } [get_ports { fmc_oen }]; #IO_L18P_T2_16 Sch=fmc_la_p[20]
set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS25 } [get_ports { fmc_be[0] }]; #IO_L14N_T2_SRCC_16 Sch=fmc_la_n[21]
set_property -dict { PACKAGE_PIN E19   IOSTANDARD LVCMOS25 } [get_ports { fmc_be[1] }]; #IO_L14P_T2_SRCC_16 Sch=fmc_la_p[21]
set_property -dict { PACKAGE_PIN D21   IOSTANDARD LVCMOS25 } [get_ports { fmc_siwun }]; #IO_L23N_T3_16 Sch=fmc_la_n[22]
set_property -dict { PACKAGE_PIN E21   IOSTANDARD LVCMOS25 } [get_ports { fmc_wrn }]; #IO_L23P_T3_16 Sch=fmc_la_p[22]
...
set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS25 } [get_ports { fmc_data[12] }]; #IO_L7N_T1_16 Sch=fmc_la_n[24]
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS25 } [get_ports { fmc_data[14] }]; #IO_L7P_T1_16 Sch=fmc_la_p[24]
set_property -dict { PACKAGE_PIN E17   IOSTANDARD LVCMOS25 } [get_ports { fmc_data[13] }]; #IO_L2N_T0_16 Sch=fmc_la_n[25]
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS25 } [get_ports { fmc_data[15] }]; #IO_L2P_T0_16 Sch=fmc_la_p[25]
...
set_property -dict { PACKAGE_PIN B13   IOSTANDARD LVCMOS25 } [get_ports { fmc_data[8] }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]
set_property -dict { PACKAGE_PIN C13   IOSTANDARD LVCMOS25 } [get_ports { fmc_data[10] }]; #IO_L8P_T1_16 Sch=fmc_la_p[28]
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS25 } [get_ports { fmc_data[9] }]; #IO_L3N_T0_DQS_16 Sch=fmc_la_n[29]
set_property -dict { PACKAGE_PIN C14   IOSTANDARD LVCMOS25 } [get_ports { fmc_data[11] }]; #IO_L3P_T0_DQS_16 Sch=fmc_la_p[29]
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS25 } [get_ports { fmc_data[4] }]; #IO_L10N_T1_16 Sch=fmc_la_n[30]
set_property -dict { PACKAGE_PIN A13   IOSTANDARD LVCMOS25 } [get_ports { fmc_data[6] }]; #IO_L10P_T1_16 Sch=fmc_la_p[30]
set_property -dict { PACKAGE_PIN E14   IOSTANDARD LVCMOS25 } [get_ports { fmc_data[5] }]; #IO_L4N_T0_16 Sch=fmc_la_n[31]
set_property -dict { PACKAGE_PIN E13   IOSTANDARD LVCMOS25 } [get_ports { fmc_data[7] }]; #IO_L4P_T0_16 Sch=fmc_la_p[31]
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS25 } [get_ports { fmc_data[0] }]; #IO_L9N_T1_DQS_16 Sch=fmc_la_n[32]
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS25 } [get_ports { fmc_data[2] }]; #IO_L9P_T1_DQS_16 Sch=fmc_la_p[32]
set_property -dict { PACKAGE_PIN F14   IOSTANDARD LVCMOS25 } [get_ports { fmc_data[1] }]; #IO_L1N_T0_16 Sch=fmc_la_n[33]
set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVCMOS25 } [get_ports { fmc_data[3] }]; #IO_L1P_T0_16 Sch=fmc_la_p[33]
