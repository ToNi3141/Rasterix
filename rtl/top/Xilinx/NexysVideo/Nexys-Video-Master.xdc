...
set_property -dict {PACKAGE_PIN Y1 IOSTANDARD TMDS_33} [get_ports hdmi_tx_b_n]
set_property -dict {PACKAGE_PIN W1 IOSTANDARD TMDS_33} [get_ports hdmi_tx_b_p]
set_property -dict {PACKAGE_PIN AB1 IOSTANDARD TMDS_33} [get_ports hdmi_tx_g_n]
set_property -dict {PACKAGE_PIN AA1 IOSTANDARD TMDS_33} [get_ports hdmi_tx_g_p]
set_property -dict {PACKAGE_PIN AB2 IOSTANDARD TMDS_33} [get_ports hdmi_tx_r_n]
set_property -dict {PACKAGE_PIN AB3 IOSTANDARD TMDS_33} [get_ports hdmi_tx_r_p]
...
set_property -dict {PACKAGE_PIN K21 IOSTANDARD LVCMOS25} [get_ports fmc_wkup]
...
set_property -dict {PACKAGE_PIN J22 IOSTANDARD LVCMOS25} [get_ports fmc_gpio0]
...
set_property -dict {PACKAGE_PIN D17 IOSTANDARD LVCMOS25} [get_ports fmc_clk]
set_property -dict {PACKAGE_PIN A19 IOSTANDARD LVCMOS25} [get_ports fmc_txen]
set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS25} [get_ports fmc_rxfn]
set_property -dict {PACKAGE_PIN F20 IOSTANDARD LVCMOS25} [get_ports fmc_rdn]
set_property -dict {PACKAGE_PIN F19 IOSTANDARD LVCMOS25} [get_ports fmc_oen]
set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVCMOS25} [get_ports {fmc_be[0]}]
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS25} [get_ports {fmc_be[1]}]
set_property -dict {PACKAGE_PIN D21 IOSTANDARD LVCMOS25} [get_ports fmc_siwun]
set_property -dict {PACKAGE_PIN E21 IOSTANDARD LVCMOS25} [get_ports fmc_wrn]
...
set_property -dict {PACKAGE_PIN B16 IOSTANDARD LVCMOS25} [get_ports {fmc_data[12]}]
set_property -dict {PACKAGE_PIN B15 IOSTANDARD LVCMOS25} [get_ports {fmc_data[14]}]
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS25} [get_ports {fmc_data[13]}]
set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS25} [get_ports {fmc_data[15]}]
...
set_property -dict {PACKAGE_PIN B13 IOSTANDARD LVCMOS25} [get_ports {fmc_data[8]}]
set_property -dict {PACKAGE_PIN C13 IOSTANDARD LVCMOS25} [get_ports {fmc_data[10]}]
set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS25} [get_ports {fmc_data[9]}]
set_property -dict {PACKAGE_PIN C14 IOSTANDARD LVCMOS25} [get_ports {fmc_data[11]}]
set_property -dict {PACKAGE_PIN A14 IOSTANDARD LVCMOS25} [get_ports {fmc_data[4]}]
set_property -dict {PACKAGE_PIN A13 IOSTANDARD LVCMOS25} [get_ports {fmc_data[6]}]
set_property -dict {PACKAGE_PIN E14 IOSTANDARD LVCMOS25} [get_ports {fmc_data[5]}]
set_property -dict {PACKAGE_PIN E13 IOSTANDARD LVCMOS25} [get_ports {fmc_data[7]}]
set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS25} [get_ports {fmc_data[0]}]
set_property -dict {PACKAGE_PIN A15 IOSTANDARD LVCMOS25} [get_ports {fmc_data[2]}]
