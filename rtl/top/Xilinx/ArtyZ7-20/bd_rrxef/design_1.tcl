...
proc create_root_design { parentCell } {
  ...
  if { [catch {set RasterixEF_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    CONFIG.ID_WIDTH {6} \
    CONFIG.RASTERIZER_ENABLE_FLOAT_INTERPOLATION {1} \
...
{ AR_SIZE 16 R_SIZE 16 } } }  } \
  ...
  connect_bd_intf_net -intf_net Dvi_0_m_mem_axi [get_bd_intf_pins Dvi_0/m_mem_axi] [get_bd_intf_pins smartconnect_0/S03_AXI]
