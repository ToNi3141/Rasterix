...
proc create_root_design { parentCell } {
  ...
  if { [catch {set Dvi_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.FB_ADDR {0x0FE00000} $Dvi_0
...
\
  ...
  connect_bd_intf_net -intf_net Rasterix_0_m_framebuffer_axis [get_bd_intf_pins Rasterix_0/m_framebuffer_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net Rasterix_0_m_mem_axi [get_bd_intf_pins Rasterix_0/m_mem_axi] [get_bd_intf_pins axi_protocol_convert_1/S_AXI]
  ...
  assign_bd_address -offset 0x00000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces Rasterix_0/m_mem_axi] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] -force
