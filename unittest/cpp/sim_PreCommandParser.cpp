...
TEST_CASE("Stream data simple", "[Stream]")
{
    ...
    for (uint32_t i = 0; i < 2; i++) 
    {
        ...
        // Read first 4 bytes from master interface 
        REQUIRE(t.m_axis_tvalid == 1);
        REQUIRE(t.m_axis_tdata == 0xff00ff00);
        REQUIRE(t.m_axis_tlast == 1);
